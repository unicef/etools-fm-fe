...
function setMaxHeight(paperTextarea: PaperTextareaElement): void {
    ...
    const textareaAutoGrow: IronAutogrowTextareaElement | null = paperInputContainer &&
        paperInputContainer.querySelector('.paper-input-input');

    if (!textareaAutoGrow) { return; }
