...
export const LocationWidgetStyles: CSSResult = css`
    ...
    .widget-container .map-and-list .list paper-input { margin-top: -20px; }
    ...
    .widget-container .map-and-list .list .location-line:last-child { margin-bottom: 0; }
    ...
    .widget-container .map-and-list .list .location-line .deselect-btn span { display: none; }

    .widget-container .map-and-list .list .site-line.selected,
    .widget-container .map-and-list .list .location-line.selected .deselect-btn { background-color: #f3e5bf; }

    .widget-container .map-and-list .list .site-line.selected .deselect-btn span,
    .widget-container .map-and-list .list .location-line.selected .deselect-btn span { display: inline; }

    .locations-list div:not(.missing-sites) ~ .no-search-results,
    .locations-list div.missing-sites:not([hidden]) + .no-search-results{ display: none; }
`;
