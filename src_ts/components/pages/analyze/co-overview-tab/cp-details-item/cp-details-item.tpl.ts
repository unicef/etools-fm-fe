        ...
        <div class="full-report-container">
            ...
            <div class="cp-indicators">
                ...
                ${this.fullReport && this.fullReport.ram_indicators && this.fullReport.ram_indicators.length ?
                        this.fullReport.ram_indicators.map((item: any, index: number) =>
                        html`
            ...
            <div class="partners">
                ...
                <div class="layout horizontal">
                    ...
                    <div class="flex-4 layout horizontal">
                        ...
                        <div class="flex-none layout horizontal center-center w120px line title">Days Since Last<br> Site Visit</div>
                            ...
                            <div class="flex-4 intervention-data">
                                ${partner.interventions && partner.interventions.length ?
                                    repeat(
                                        ...
                                        (intervention: FullReportIntervention) => html`
                                            <div class="layout horizontal">
                                                <div class="flex-none w45px layout horizontal center-center">
                                                    <iron-icon icon="expand-more" ?hidden="${this.detailsOpened[intervention.pk]}" @tap="${() => this.toggleDetails(intervention)}"></iron-icon>
                                                    <iron-icon icon="expand-less" ?hidden="${!this.detailsOpened[intervention.pk]}" @tap="${() => this.toggleDetails(intervention)}"></iron-icon>
                                                </div>
                                                ...
                                                <div class="flex-none w150px layout horizontal links">
                                                    ...
                                                    <a href="${`/apd/action-points/list?cp_output=${this.cpItem.id}&intervention=${intervention.pk}`}" target="_blank">
                                        ...
                                        `)
                                    : html`
                                        <div class="layout horizontal" ?hidden="${!partner.interventions || !partner.interventions.length}">
