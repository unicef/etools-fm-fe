...
export class ReportReviewerPopup extends LitElement {
  ...
  set dialogData({activity}: ReportReviewerPopupData) {
    ...
    this.reviewerInfoText = this.activity.report_reviewer_preliminary ? getTranslation('ACTIVITY_DETAILS.REPORT_REVIEWER_CONFIRM')
  ...
  confirmReviewer(): void {
    ...
    fireEvent(this, 'dialog-closed', {confirmed: true, response: {reviewer: this.activity.report_reviewer_preliminary.id}});
  }
