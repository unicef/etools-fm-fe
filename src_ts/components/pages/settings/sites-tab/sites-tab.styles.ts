...
// language=HTML
export const SitesTabStyles: TemplateResult = html`
    <style>
        :host {
            position: relative;
            display: block;
        ...
        .site-row:hover { background-color: #eeeeee; }
        .site-row:first-child { border-top: none; }
        .site-row .hover-block { right: 24px; }
        ...
        .site-row .active-marker.active { background-color: #309a53; }
