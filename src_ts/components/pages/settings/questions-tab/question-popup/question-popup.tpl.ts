        ...
        <etools-dialog
            ...
            <div class="container layout vertical">
                ...
                <etools-dropdown-multi
                            ...
                            @etools-selected-items-changed="${({ detail }: CustomEvent) => this.updateModelValue('methods', detail.selectedItems)}"
                            trigger-value-change-event
                            hide-search
                ...
                <div class="layout horizontal">
                    ...
                    <etools-dropdown
                                ...
                                @etools-selected-item-changed="${({ detail }: CustomEvent) => this.updateModelValue('category', detail.selectedItem.id)}"
                                trigger-value-change-event
                    ...
                    <etools-dropdown
                                ...
                                @etools-selected-item-changed="${({ detail }: CustomEvent) => this.updateModelValue('level', detail.selectedItem.value)}"
                                trigger-value-change-event
                                hide-search
                ...
                <div class="checkboxes">
                    <paper-checkbox ?checked="${ this.editedQuestion.is_hact }"
                                    @change="${ (event: CustomEvent) => this.updateModelValue('is_hact', (event.target as PaperCheckboxElement).checked) }">
                                ${ translate('QUESTIONS.LABELS.IS_HACT') }
                    </paper-checkbox>
                    <paper-checkbox ?checked="${ this.editedQuestion.is_active }"
                                    @change="${ (event: CustomEvent) => this.updateModelValue('is_active', (event.target as PaperCheckboxElement).checked) }">
                ...
                <div class="layout horizontal">
                    ...
                    <etools-dropdown
                                ...
                                @etools-selected-item-changed="${({ detail }: CustomEvent) => this.changeOptionsSize(detail.selectedItem && detail.selectedItem.value)}"
                                trigger-value-change-event
                                hide-search
                ...
                <div class="scales-container" ?hidden="${ this.editedQuestion.answer_type !== SCALE_TYPE && this.editedQuestion.answer_type !== BOOLEAN_TYPE }">
                    ${ repeat(
