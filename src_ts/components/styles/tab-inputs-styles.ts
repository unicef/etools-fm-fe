...
export const TabInputsStyles: TemplateResult = html`
    <style>
         paper-icon-button[hidden] {
            ...
            .filter-dropdown etools-dropdown,
            .filter-dropdown etools-dropdown-multi {
                min-width: 240px;
            }
            ...
            etools-dropdown-multi[readonly]:not(.datepicker), etools-dropdown-multi[disabled].disabled-as-readonly,
            ...
            .repeatable-item-container.whithout-actions { padding: 0  !important; }
            ...
            .repeatable-item-container .repeatable-item-actions .actions.action {
                            width: 36px;
                            height: 36px;
             }
            .repeatable-item-container .repeatable-item-actions .actions.action.delete { color: #ea4022; }
            .repeatable-item-container .repeatable-item-actions .actions.action.add { color: var(--module-primary); }
            .repeatable-item-container .repeatable-item-actions .actions.action[disabled] { color: var(--gray-light); }
            ...
            .repeatable-item-container .repeatable-item-content .staff-check-box { margin-top: 10px; }
